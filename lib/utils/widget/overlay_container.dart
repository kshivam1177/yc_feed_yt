...
class OverlayContainer extends StatefulWidget {
  ...
  OverlayContainer({
    ...
    this.position = const OverlayContainerPosition(0, 0, 0),
  }) : super(key: key);
      ...
      builder: (BuildContext context) {
        return Positioned(
          left: widget.position.left != null
              ? offset.dx + widget.position.left
              : null,
          right: widget.position.right,
          top: widget.position.top != null
              ? offset.dy + widget.position.top
              : null,
...
/// The Overlay can however be moved around by giving position values
